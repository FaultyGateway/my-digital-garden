...
>- If you are losing track of what stage of progress you are on when working on multiple devices, pair down the number you are working simultaneously on till you feel comfortable again.
>- Keep drinks out of arm/elbow reach so you don't accidentally knock it over.

>[!warning]+ Interns!
>- If you need to stop work on a device and come back to it at a later date, take notes and attach it to the device. You can use masking tape, sticky notes, or print out on receipt paper.
